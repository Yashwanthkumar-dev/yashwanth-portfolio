  ...
  return (
    <>
      <div className="bg-primary outline-0 scroll-smooth">
        ...
        {/* Hero Section */}
        <section
          className="relative px-6 pt-2 pb-16 font-poppins md:mt-30 xl:mx-24"
          id="home"
        >
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10">
            ...
            <div className="md:pl-10">
              <h3 className="text-gray-400/60 uppercase text-sm tracking-widest">
                GET STARTED
              </h3>
              <div className="flex flex-col gap-4 mt-4">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  className="rounded-lg py-3 px-10 text-white bg-blue-700 hover:bg-accent transition duration-500 shadow-md"
                >
                  <a href="#project">view project</a>
                </motion.button>
                <motion.a
                  href="/yashwanth-kumar-resume.pdf"
                  download
                  whileHover={{ scale: 1.05 }}
                  className="rounded-lg py-3 px-10 text-white/40 border border-white/20 backdrop-blur-md bg-white/5 text-center"
                >
                  My resume
                </motion.a>
              </div>
        ...
        <div className="py-10 border-y border-white/5 overflow-hidden whitespace-nowrap">
          ...
          >
            {[...skills, ...skills].map((skill, i) => (
              <span
                key={i}
                className="text-white/20 font-poppins uppercase tracking-widest flex items-center gap-4"
              >
        ...
        {/* About Section */}
        <section
          className="mt-20 leading-relaxed xl:mx-24 pb-20 px-6"
          id="about"
        >
          <p className="text-accent font-poppins xl:text-xl">About</p>
          <h1 className="text-white font-poppins mt-2 text-4xl font-semibold xl:text-6xl">
            Who I am.
          </h1>
          ...
          <div className="xl:flex xl:justify-between gap-16 mt-10">
            ...
            >
              ...
              <div className="h-48 border-b border-white/10 text-[4rem] flex items-center justify-center">
                👨‍💻
              </div>
              <p className="mt-5 font-semibold">Yashwanth kumar</p>
              <p className="text-accent uppercase text-xs font-bold tracking-widest mt-1">
                java full stack developer
              </p>

              <div className="mt-6 space-y-4">
                <div className="flex justify-between border-b border-white/5 pb-2 text-sm text-white/40">
                  <span>location</span>
                  <span className="text-white">TamilNadu, India</span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2 text-sm text-white/40">
                  <span>Stack</span>
              ...
              <div className="flex items-center px-4 py-2 gap-x-3 bg-green-400/10 rounded-lg mt-6">
                ...
                <h2 className="text-green-500 text-xs font-bold uppercase tracking-widest">
                  open to work
                </h2>
              </div>
            </motion.div>
            ...
            <div className="flex-1">
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                {[
                  ...
                  <span
                    key={trait}
                    className="bg-white/5 px-5 py-2 rounded-xl text-white/30 border border-white/10 text-xs hover:border-accent hover:text-accent cursor-default transition-all"
                  >
                    {trait}
                  </span>
                ))}
        ...
        {/* Projects Section */}
        <div
          className="border-t border-white/5 py-24 mx-6 xl:mx-24"
          id="project"
        >
          <h3 className="text-accent font-poppins xl:text-xl uppercase tracking-widest">
            work
          </h3>
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16">
            <h1 className="text-white font-poppins text-4xl font-semibold xl:text-6xl">
              Selected projects.
            </h1>
            <p className="text-white/40 font-poppins max-w-xs mt-4">
              Real apps built end-to-end from database to deployment.
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  <h1 className="font-poppins text-accent text-xl">
                    {p.title}
                  </h1>
                  <a href={p.link} target="_blank" rel="noreferrer">
                    <ExternalLink
                      size={20}
                      className="text-accent group-hover:scale-125 transition-all"
                    />
                  </a>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  {p.tech.map((t) => (
                    <span
                      key={t}
                      className="border border-accent/30 px-4 py-1 rounded-full text-accent text-[10px] uppercase tracking-widest"
                    >
                      {t}
                    </span>
                  ))}
        ...
        <div className="border-t border-white/5 mx-6 xl:mx-24 py-24">
          <p className="text-accent uppercase tracking-widest xl:text-xl">
            expertise
          </p>
          <h1 className="text-white font-poppins text-4xl font-semibold xl:text-6xl mb-16">
            What I bring.
          </h1>
            ...
            {[
              {
                ...
                subtitle: "building logic and experience",
                desc: "I architect systems where every piece fits perfectly. My strength lies in bridging the gap between a high-performance Java backend and a seamless React frontend.",
              },
              {
                icon: <Database size={22} />,
                title: "Backend & Database",
                subtitle: "Data Built for the Long Haul",
                desc: "Focusing on clean MySQL schemas optimized for speed and integrity. I build for today with an eye on tomorrow.",
              },
              {
                icon: <MonitorSmartphone size={22} />,
                title: "Frontend Excellence",
                subtitle: "Interfaces with an Impact",
                desc: "Using Tailwind CSS, I craft pixel-perfect, mobile-first UIs that don't just look good but feel natural to use.",
              },
              {
                icon: <Code2 size={22} />,
                title: "Software Engineering",
                subtitle: "Code that Speaks for Itself",
                desc: "Writing code that is clean, modular, and built to be shared. Following SOLID principles to ensure scalability.",
              },
            ].map((e, idx) => (
              <motion.div
                key={idx}
              ...
              >
                <h1 className="text-white/80 text-xl font-semibold mb-4">
                  {e.title}
                </h1>
                ...
                <p className="text-white/40 text-sm leading-relaxed text-justify">
                  {e.desc}
                </p>
              </motion.div>
            ))}
        ...
        <footer className="border-t border-white/5 pt-24 pb-12" id="contact">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <span className="border border-accent/50 px-6 py-2 rounded-full bg-white/5 text-accent text-xs uppercase tracking-[0.3em]">
              Let's connect
            </span>
            <h1 className="font-bold text-white text-6xl md:text-8xl tracking-tighter mt-12">
              let's build
            </h1>
            <p className="text-accent italic text-6xl md:text-8xl tracking-tighter -mt-2">
              together.
            </p>
            <p className="text-white/30 mt-10 max-w-sm mx-auto leading-relaxed">
            ...
            <div className="mt-16 max-w-md mx-auto">
              <form
                ...
                className="flex flex-col sm:flex-row gap-3 p-1.5 bg-white/5 border border-white/10 rounded-2xl focus-within:border-accent/50 transition-all"
              >
                ...
                <input
                  ...
                  name="email"
                  required
                  className="flex-1 bg-transparent py-4 px-6 outline-none text-white text-sm"
                />
                <button
                  type="submit"
                  className="bg-accent hover:bg-accent/80 text-white px-8 py-4 rounded-xl font-bold transition-all active:scale-95 text-xs uppercase"
                >
                  Submit
                </button>
              </form>
